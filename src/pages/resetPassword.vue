<template>
    <div class="password-reset-page">
        <div class="page-content">
            <h2>Сброс пароля</h2>
            <p>Введите ваш логин и новый пароль ниже:</p>
...
export default{
    ...
    methods:{
        async resetPassword(){
            try {
                const res = await requester("POST", "auth/resetPassword?urlTag="+this.$route.query.urlTag,{
                    username:this.login,
                ...
                console.error(err);
                this.error = "Произошла ошибка при сбросе пароля:  " + err.response.data.message;
            }
        }
    }
}
